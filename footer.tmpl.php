        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="info_links pl-lg-5">
                    ...
                    <ul>
                        <li class="<?php if ($current_page === 'index') {
                            echo 'active';
                        } ?>">
                            <a href="index.php">
                                Home
                        ...
                        <li class="<?php if ($current_page === 'gallery') {
                            echo 'active';
                        } ?>">
                            <a href="gallery.php">
                                Gallery
...
<footer class="container-fluid footer_section">
    ...
    <p>Made with ❤ by <a href="https://denmau.me" class="text-primary">Dennis Kamau</a></p>
</footer>
<!-- footer section -->
